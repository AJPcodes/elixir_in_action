defmodule TodoServer do
  ...
  def start do
    todo_pid = spawn(fn -> loop(TodoList.new) end)
    Process.register(todo_pid, :todo_server)
  end
...
TodoServer.start()
TodoServer.add_entry(%{date: {2017, 7, 2}, title: "Pet Marzi"})
TodoServer.entries({2013, 7, 2})